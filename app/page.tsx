  ...
  return (
    <main>
      ...
      <section className="relative h-screen w-full overflow-hidden">
        <Image
          src="https://picsum.photos/seed/casanorden-rio/1920/1200?grayscale"
          alt=""
          fill
          priority
          sizes="100vw"
      ...
      <section className="bg-stone py-24 lg:py-32">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-12">
            {[
              { seed: "urquiza", name: "Justo José de Urquiza" },
              { seed: "ramirez", name: "Francisco Ramírez" },
              { seed: "delavega", name: "La Delfina" },
              { seed: "bredeston", name: "Guillermo Bredeston" },
              { seed: "chamot", name: "José Chamot" },
            ].map((m) => (
              <Link key={m.seed} href="/memorias" className="memory-circle group text-center reveal">
                <div className="relative aspect-square rounded-full overflow-hidden mx-auto w-32 md:w-36">
                  <Image
                    src={`https://picsum.photos/seed/${m.seed}/400/400?grayscale`}
                    fill
                    sizes="144px"
      ...
      <section className="relative bg-ink text-stone py-28 lg:py-40 overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          ...
          <div className="relative mt-16 h-[420px] md:h-[560px] reveal">
            <Image
              src="https://picsum.photos/seed/casanorden-earth/1400/720?grayscale"
              fill
      ...
      <section className="relative h-[80vh] min-h-[520px] w-full overflow-hidden">
        <Image
          src="https://picsum.photos/seed/palacio-sanjose/1920/1200?grayscale"
          fill
          sizes="100vw"
          className="object-cover"
          alt=""
      ...
      <section className="bg-white py-24 lg:py-32">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { href: "/memorias", seed: "caudillo", tag: "Memorias", title: "El Supremo Entrerriano" },
              { href: "/lugares", seed: "basilica", tag: "Lugares", title: "Basílica de la Inmaculada" },
              { href: "/fechas", seed: "pronunciamiento", tag: "Fechas Recordadas", title: "1 de mayo de 1851" },
              { href: "/leyendas", seed: "salamanca", tag: "Leyendas", title: "La Salamanca" },
            ].map((c) => (
              <Link key={c.seed} href={c.href} className="card group reveal">
                <div className="relative overflow-hidden aspect-[4/5]">
                  <Image
                    src={`https://picsum.photos/seed/${c.seed}/600/750?grayscale`}
                    fill
      ...
      <section className="relative h-[60vh] min-h-[420px] w-full overflow-hidden">
        <Image
          src="https://picsum.photos/seed/cdu-ciudad/1920/1000?grayscale"
          fill
          sizes="100vw"
          className="object-cover"
          alt=""
